...
public class SessionManagerConfiguration {
    ...
    @Value("${spring.data.redis.expirationTimeSeconds}")
    private int redisSessionExpirationTimeSeconds;

    @Bean
    public SessionManager sessionManager() {
        return new RedisSessionManager(new Jedis(redisHost, redisPort), redisSessionExpirationTimeSeconds);
    }
}
